...
<body>
    ...
    <div class="container col-md-3"  id="login-form">
        <div class="container">
            <form action="login.php" method="post" class = "form-horizontal col-md-12 form">
                <?=$errorMessage ?>
                ...
                <footer class="footer">
                    ...
                    <a href="signup.php" class="account">Signup</a>
                </footer>
            </form>
        </div>
    </div>
